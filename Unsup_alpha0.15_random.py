...
K=20 #number of different trees
...
for rep1 in range(40):
    ...
    for rep in range(100):
        ...
        for i in range(len(s0)):
            if s0[i]<0:
                N.append(10)  #random number of samples, in \{10,20\} with probability 1/2
            else:
                N.append(20)
        s = np.random.normal(0,0,K) #mu can be (mean,std)=(0,0), (0,0.5), (0,2), (0,10)
        mat=[]
        for j in range(K):
